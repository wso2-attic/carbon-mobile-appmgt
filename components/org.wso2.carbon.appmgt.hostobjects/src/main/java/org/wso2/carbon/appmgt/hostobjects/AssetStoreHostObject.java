...
public class AssetStoreHostObject extends ScriptableObject {
    ...
    public AssetStoreHostObject() throws AppManagementException {
        //this(null);
    }
    ...
    private void createRegistry(String username) throws RegistryException {
        ...
        if (username != null) {
            governanceRegistry =
                    ServiceReferenceHolder.getInstance().getRegistryService().getGovernanceUserRegistry(
                            username);
            rootRegistry =
                    ServiceReferenceHolder.getInstance().getRegistryService().getRegistry(username);
        } else {
            governanceRegistry =
                    ServiceReferenceHolder.getInstance().getRegistryService().getGovernanceSystemRegistry();
            rootRegistry =
                    ServiceReferenceHolder.getInstance().getRegistryService().getRegistry(
    ...
    public AssetStoreHostObject(String loggedUser) throws AppManagementException {
        username = loggedUser;
        try {
    ...
    private static void buildDataRows(Scriptable thisObj, NativeArray myn,
        ...
        for (GovernanceArtifact artifact : artifacts) {
            ...
            setFromAttribute(artifact, row, "version", AppMConstants.API_OVERVIEW_VERSION);
            setFromAttribute(artifact, row, "description", AppMConstants.API_OVERVIEW_DESCRIPTION);
    ...
    public static NativeArray jsFunction_searchAPI(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                ...
                log.error("Error from Registry WebApp while getting SearchAPI Information, No " +
                        "APIs in Registry", e);
                return apiArray;
            } catch (Exception e) {
    ...
    public static NativeArray jsFunction_searchAPIbyType(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                        ...
                        new GovernanceArtifactFilter() {
                            public boolean matches(GovernanceArtifact artifact) throws GovernanceException {
                                ...
                                if (searchType.contains("id")) {
                                    ...
                                    type = artifact.getAttribute(AppMConstants.API_OVERVIEW_PROVIDER);
                                } else if (searchType.contains("version")) {
                                    type = artifact.getAttribute(AppMConstants.API_OVERVIEW_VERSION);
                                } else {
                ...
                log.error("Error from Registry WebApp while getting SearchAPI by type Information" +
                        ", No APIs in Registry", e);
                return apiArray;
            } catch (Exception e) {
    ...
    public static NativeArray jsFunction_getAPIsWithTag(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try{
                ...
                log.error("Error from Registry WebApp while getting APIs With Tag Information, " +
                        "No APIs in Registry", e);
                return apiArray;
            } catch (Exception e) {
    ...
    public static NativeArray jsFunction_getSubscribedAPIs(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                ...
                log.error("Error from Registry WebApp while getting Subscribed APIs, No APIs in " +
                        "Registry.", e);
                return apiArray;
            } catch (Exception e) {
    ...
    public static NativeArray jsFunction_getAllPublishedAPIs(Context cx,
        ...
        NativeArray myn = new NativeArray(0);
        try {
            // TODO: We don't test whether this WebApp is published or not.
    ...
    public static NativeArray jsFunction_getAPI(Context cx, Scriptable thisObj,
        ...
        try {
            ...
            log.error("Error from Registry WebApp while getting WebApp information on " + id, e);
            return myn;
        } catch (Exception e) {
            log.error("Error while getting WebApp Information", e);
            return myn;
    ...
    public static NativeArray jsFunction_getComments(Context cx,
        ...
        try {
            ...
            log.error("Error from Registry WebApp while getting Comments for "+ id, e);
            return myn;
        } catch (Exception e) {
    ...
    public static NativeObject jsFunction_getLifecycleDetails(Context cx,
        ...
        try {
            ...
            log.error("Error from Registry WebApp while getting Lifecycle Details for "+ id, e);
    ...
    public static NativeArray jsFunction_addComments(Context cx,
        ...
        try {
            ...
            log.error("Error from Registry WebApp while adding Comments for "+ id, e);
            return myn;
        } catch (Exception e) {
    ...
    public static NativeArray jsFunction_rateAPI(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                ...
                log.error("Error from Registry WebApp while Rating WebApp " + id, e);
                return myn;
            } catch (NullPointerException e) {
                log.error("Error from Registry WebApp while Rating WebApp " + id, e);
                return myn;
            } catch (Exception e) {
                log.error("Error while Rating WebApp " + id, e);
                return myn;
            }
    ...
    public static NativeArray jsFunction_getAllDocumentation(Context cx,
        ...
        try{
            ...
            log.error("Error from Registry WebApp while getting All Documentation on "+ id, e);
            return myn;
        } catch (Exception e) {
    ...
    *//*
    ...
    public static NativeArray jsFunction_getAllSubscriptions(Context cx,
        ...
        for(SubscribedAPI subscribedAPI : subscribedAPIs) {
            ...
            if(apisArray == null) {
                ...
                appObj.put("prodKey", appObj, getAppKey(subscribedAPI.getApplication(), AppMConstants.API_KEY_TYPE_PRODUCTION));
                appObj.put("sandboxKey", appObj, getAppKey(subscribedAPI.getApplication(), AppMConstants.API_KEY_TYPE_SANDBOX));
    ...
    private static void addAPIObj(SubscribedAPI subscribedAPI, NativeArray apisArray,
        ...
        try {
            ...
            apiObj.put("prodKey", apiObj, getKey(subscribedAPI, AppMConstants.API_KEY_TYPE_PRODUCTION));
            apiObj.put("sandboxKey", apiObj, getKey(subscribedAPI, AppMConstants.API_KEY_TYPE_SANDBOX));
    ...
    public static NativeObject jsFunction_getSubscriber(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                ...
                log.error("Error from Registry WebApp while getting Subscriber"
                        + e);
                return null;
            } catch (IllegalArgumentException e) {
                log.error("Error from Registry WebApp while getting Subscriber "
    ...
    public static boolean jsFunction_addSubscriber(Context cx,
        ...
        if (isStringArray(args)) {
            ...
            try {
                ...
                log.error("Error from Registry WebApp while adding Subscriber"
                        + e);
                return false;
            } catch (IllegalArgumentException e) {
                log.error("Error from Registry WebApp while adding Subscriber "
